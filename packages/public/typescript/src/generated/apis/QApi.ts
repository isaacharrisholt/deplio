...
export interface QApiCreateRequest {
    messages: Messages;
    deplio_version?: Date;
}
...
export interface QApiInterface {
     ...
     */
    createRaw(requestParameters: QApiCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PostQMessagesResponse>>;

    /**
     * Send messages to Deplio Q to be processed asynchronously.
     * Send messages to Deplio Q
     */
    create(requestParameters: QApiCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PostQMessagesResponse>;
...
export class QApi extends runtime.BaseAPI implements QApiInterface {
     ...
     * Send messages to Deplio Q
     */
    async createRaw(requestParameters: QApiCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PostQMessagesResponse>> {
        if (requestParameters.messages === null || requestParameters.messages === undefined) {
            throw new runtime.RequiredError('messages','Required parameter requestParameters.messages was null or undefined when calling create.');
        }
     ...
     * Send messages to Deplio Q
     */
    async create(requestParameters: QApiCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PostQMessagesResponse> {
