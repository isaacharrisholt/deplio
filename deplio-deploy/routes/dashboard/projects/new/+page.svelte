...
>
  ...
  <p>
    Select the GitHub repository you'd like to include in this project. Repos without a <code
      class="code">deplio.yaml</code
    > file in their root will be ignored during deployments.
  </p>
  ...
  <button type="submit" class="btn variant-filled-secondary mt-4" disabled={!canSubmit}
